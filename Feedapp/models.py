...
class FeedBack(models.Model):
    ...
    A1        = models.IntegerField(choices=list(zip(range(1, 11), range(1, 11))),blank=False,default=0)
    A2        = models.IntegerField(choices=list(zip(range(1, 11), range(1, 11))),blank=False,default=0)
    A3        = models.IntegerField(choices=list(zip(range(1, 11), range(1, 11))),blank=False,default=0)
    A4        = models.IntegerField(choices=list(zip(range(1, 11), range(1, 11))),blank=False,default=0)
    A5        = models.IntegerField(choices=list(zip(range(1, 11), range(1, 11))),blank=False,default=0)
    A6        = models.IntegerField(choices=list(zip(range(1, 11), range(1, 11))),blank=False,default=0)
    A7        = models.IntegerField(choices=list(zip(range(1, 11), range(1, 11))),blank=False,default=0)
    A8        = models.IntegerField(choices=list(zip(range(1, 11), range(1, 11))),blank=False,default=0)
    A9        = models.IntegerField(choices=list(zip(range(1, 11), range(1, 11))),blank=False,default=0)
    A10       = models.IntegerField(choices=list(zip(range(1, 11), range(1, 11))),blank=False,default=0)
    A11       = models.IntegerField(choices=list(zip(range(1, 11), range(1, 11))),blank=False,default=0)
    A12       = models.IntegerField(choices=list(zip(range(1, 11), range(1, 11))),blank=False,default=0)
