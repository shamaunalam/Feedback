...
class FeedBack(models.Model):
    ...
    A1        = models.IntegerField(_("How well the course was organised?"),choices=list(zip(range(2, 11), range(2, 11))),blank=False,default=0)
    A2        = models.IntegerField(_("How confident do you feel about your grasp of this module content ?"),choices=list(zip(range(2, 11), range(2, 11))),blank=False,default=0)
    A3        = models.IntegerField(_("How do you rate the learning environment during your training?"),choices=list(zip(range(2, 11), range(2, 11))),blank=False,default=0)
    A4        = models.IntegerField(_("How satisfied you are by the training facility provided to you?"),choices=list(zip(range(2, 11), range(2, 11))),blank=False,default=0)
    A5        = models.IntegerField(_("How was the quality of study material provided to you?"),choices=list(zip(range(2, 11), range(2, 11))),blank=False,default=0)
    A6        = models.IntegerField(_("How effective do you find the faculty?"),choices=list(zip(range(2, 11), range(2, 11))),blank=False,default=0)
    A7        = models.IntegerField(_("How satisfactory did you find their answers to your queries?"),choices=list(zip(range(2, 11), range(2, 11))),blank=False,default=0)
    A8        = models.IntegerField(_("How thorough was their knowledge of course contents?"),choices=list(zip(range(2, 11), range(2, 11))),blank=False,default=0)
    A9        = models.IntegerField(_("How inspiring was your association with the faculty?"),choices=list(zip(range(2, 11), range(2, 11))),blank=False,default=0)
    A10       = models.IntegerField(_("How do you rate the assistance provided during your training?"),choices=list(zip(range(2, 11), range(2, 11))),blank=False,default=0)
    A11       = models.IntegerField(_("How effective was the consultation provided?"),choices=list(zip(range(2, 11), range(2, 11))),blank=False,default=0)
    A12       = models.IntegerField(_("How well were the stated objectives of the module achieved?"),choices=list(zip(range(2, 11), range(2, 11))),blank=False,default=0)
